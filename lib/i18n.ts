...
export const PUBLIC_COPY = {
  fr: {
    ...
    common: {
      ...
      upload: 'Glisser-deposer ou cliquer',
      fileTooLarge: 'Fichier trop volumineux (max 8 Mo).',
      uploadFailed: 'Echec du televersement.',
      error: 'Erreur.',
      unknownError: 'Erreur inconnue.',
      phoneOrEmailRequired: 'Telephone ou courriel requis.',
      consentRequired: 'Le consentement est obligatoire.',
      responseFast: 'Reponse rapide pendant les heures de bureau.',
      call: 'Appeler',
      writeUs: 'Nous ecrire',
    ...
    jobs: {
      pageTitle: 'Mandats en sante',
      eyebrow: 'Postes',
      intro:
        "Filtrez les postes par profession, region, ville, etablissement, departement, quart ou type de mandat. Les postes affiches sont actifs et provenant d'Agence Sanitas.",
      emptyTitle: 'Aucun poste ne correspond.',
      emptyBody:
        "Essayez d'elargir vos criteres, ou envoyez-nous votre profil. Nous vous contacterons lorsqu'un mandat compatible sera disponible.",
      ...
      particularities: 'Particularites',
      ...
      fallbackRequirements:
        "L'equipe Sanitas confirmera les exigences detaillees avec vous avant toute presentation.",
      fallbackParticularities:
        "Les particularites du mandat seront validees avec le recruteur Sanitas.",
    },
  },
  en: {
    localeName: 'English',
