...
export const OPTION_LABELS: Record<string, Partial<Record<Locale, string>>> = {
  ...
  'Oui, disponible pour relocalisation': { en: 'Yes, available for relocation' },
  'À confirmer': { en: 'To confirm' },
  "Besoin d'accompagnement": { en: 'Support needed' },
