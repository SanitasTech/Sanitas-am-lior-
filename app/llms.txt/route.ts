...
export async function GET() {
  ...
  const lines = [
    ...
    '',
    '## Summary',
    'Agence Sanitas is a healthcare staffing and recruitment agency based in Laval, Quebec. The public website serves healthcare candidates and healthcare institutions in French and English. The admin/recruiter ATS is private and should not be indexed.',
    '',
    '## Main audiences',
    '- Healthcare candidates in Quebec and Canada looking for assignments.',
    '- Nurses, licensed practical nurses, PABs, ASSS and specialized healthcare professionals.',
