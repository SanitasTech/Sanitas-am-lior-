...
export async function POST(req: Request) {
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      establishment_en: input.establishment_en || null,
      department: input.department || null,
      shift: input.shift || null,
      schedule: input.schedule || null,
      schedule_en: input.schedule_en || null,
      mandate_type: input.mandate_type || null,
      start_date: input.start_date || null,
      duration: input.duration || null,
      duration_en: input.duration_en || null,
      salary: input.salary || null,
      salary_en: input.salary_en || null,
      urgency: input.urgency,
      requirements: input.requirements || null,
      requirements_en: input.requirements_en || null,
      benefits: input.benefits || null,
      benefits_en: input.benefits_en || null,
