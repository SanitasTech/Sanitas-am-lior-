...
export async function POST(req: Request) {
  ...
  if (input.submission_type === 'posting' && input.job_id) {
    ...
    postingSnapshot = {
      ...
      establishment_en: job.establishment_en || null,
      department: job.department,
      shift: job.shift,
      schedule: job.schedule,
      schedule_en: job.schedule_en || null,
      mandate_type: job.mandate_type,
      start_date: job.start_date,
      duration: job.duration,
      duration_en: job.duration_en || null,
      salary: job.salary,
      salary_en: job.salary_en || null,
      urgency: job.urgency,
      ...
      particularities_en: job.particularities_en || null,
